...
| **.NET** | `Microsoft.AgentHostProtocol` · `Microsoft.AgentHostProtocol.Abstractions` | _NuGet publish pending_ | [`clients/dotnet/`](clients/dotnet/) · [CHANGELOG](clients/dotnet/CHANGELOG.md) |
