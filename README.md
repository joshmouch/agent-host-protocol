...
| **.NET** | `Microsoft.VisualStudioCode.AgentHostProtocol` · `Microsoft.VisualStudioCode.AgentHostProtocol.Abstractions` | NuGet.org | [`clients/dotnet/`](clients/dotnet/) · [CHANGELOG](clients/dotnet/CHANGELOG.md) |
