/**
 * Notification Types — Source of truth for AHP protocol notification methods.
 *
 * @module notifications
 * @description Protocol notifications are top-level JSON-RPC notification
 * methods that broadcast ephemeral events from the server to the client.
 * Like every notification in AHP they carry a top-level `channel: URI`
 * scoping them to a subscription. They are **not** part of the state tree,
 * are not processed by reducers, and are not replayed on reconnection.
 */
