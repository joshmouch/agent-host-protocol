 ...
 * @version 1
 */
export interface SessionToolCallStartAction extends IToolCallActionBase {
 ...
 * @version 1
 */
export interface SessionToolCallDeltaAction extends IToolCallActionBase {
 ...
 * @version 1
 */
export interface SessionToolCallReadyAction extends IToolCallActionBase {
 ...
 * @clientDispatchable
 */
export interface SessionToolCallApprovedAction extends IToolCallActionBase {
 ...
 * @clientDispatchable
 */
export interface SessionToolCallDeniedAction extends IToolCallActionBase {
  type: ActionType.SessionToolCallConfirmed;
 ...
 * @clientDispatchable
 */
export interface SessionToolCallCompleteAction extends IToolCallActionBase {
 ...
 * @clientDispatchable
 */
export interface SessionToolCallResultConfirmedAction extends IToolCallActionBase {
 ...
 * @clientDispatchable
 */
export interface SessionToolCallContentChangedAction extends IToolCallActionBase {
