...
export const ACTION_INTRODUCED_IN: { readonly [K in StateAction['type']]: string } = {
  ...
  [ActionType.CommentsThreadSet]: '0.3.0',
  [ActionType.CommentsThreadRemoved]: '0.3.0',
  [ActionType.CommentsCommentSet]: '0.3.0',
  [ActionType.CommentsCommentRemoved]: '0.3.0',
  [ActionType.CommentsCleared]: '0.3.0',
