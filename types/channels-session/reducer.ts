...
function endTurn(
  ...
  const turn: Turn = {
    ...
    ...(active.systemInitiatedLabel !== undefined ? { systemInitiatedLabel: active.systemInitiatedLabel } : {}),
    responseParts,
    usage: active.usage,
    state: turnState,
    error,
    ...
    case ActionType.SessionTurnStarted: {
      let next: SessionState = {
        ...
        activeTurn: {
          ...
          ...(action.systemInitiatedLabel !== undefined ? { systemInitiatedLabel: action.systemInitiatedLabel } : {}),
          responseParts: [],
          usage: undefined,
        },
      };
