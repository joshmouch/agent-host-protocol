 ...
 * sent. Calling {@link release} is idempotent; the final release sends the
 * protocol `unsubscribe` notification.
 */
...
export class ManagedSubscriptionManager {
  ...
  get(uri: URI): ManagedSubscription | undefined {
  ...
  private createLease(entry: Entry, owner: string): ManagedSubscriptionLease {
