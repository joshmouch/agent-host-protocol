...
const ACTION_VARIANTS: { type: string; caseName: string; tsInterface: string }[] = [
  ...
  { type: 'session/isPinnedChanged', caseName: 'SessionIsPinnedChanged', tsInterface: 'SessionIsPinnedChangedAction' },
...
const COMMAND_STRUCTS = [
  ...
  'ClientCapabilities', 'HostCapabilities', 'SessionCatalogCapabilities',
  'SessionCatalogOperatorCapabilities', 'AutomationCapabilities',
